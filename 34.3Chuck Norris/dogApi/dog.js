...
const btnRandom = document.querySelector('#btnRandom');//btn
//const img = document.querySelector('#img');
const imgList = document.querySelector('#list-of-img');//img
const numOfImg = document.querySelector('#numOfImg');//input num
